...
def reorder(ne):
    ...
    while aa<15:
        ...
        aa=aa+1
    return("".join(rrw1))
print(word_len_to_base10("اگر تا جایی که احساس می‌کنی در توانت هست و بیش از اون به خودت صدمه‌ نمی‌زنی، داد بزنی که آب هست آب هست... و همزمان این مسئوليت رو به بسپری به نفر بعدی وقتی نوبتت تموم شده‌."))
print(addnumtogethercha(alphabet_to_num("i will gonna say hello?")))
